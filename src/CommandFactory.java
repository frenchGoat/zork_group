...
/**
 * The CommandFactory Class will take in user commands as strings, parse them
 * and try to determine what the player is trying to accomplish. If parsed
 * commands can be matched to valid sub-command classes, they will be created
 * and executed, possibly causing sub-event classes to be created, but always
 * will return a string to be printed on the console to alert the player as to
 * the results of their input/actions.
 * 
...
public class CommandFactory {
	...
	/**
	 * This method receives the user command and attempts to parse it into
