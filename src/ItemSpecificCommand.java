...
class ItemSpecificCommand extends Command {
	...
	/**
	 * Command structure takes in parsed user input from CommandFactory and
	 * assigns instance variables; verb and noun.
	 * 
	 * @param verb
	 * @param noun
	 */
	...
	/**
	 * After confirming target Item object(noun) exists within the vicinity of
	 * the player, the message/event bank for that item is accessed by the verb
	 * and the appropriate events are triggered. Return string is printed to the
	 * console.
	 * 
